...
import { idlFactory } from './goodbuffer.did.js';
export { idlFactory } from './goodbuffer.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GOODBUFFER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./goodbuffer.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the goodbuffer canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./goodbuffer.did.js")._SERVICE>}
 */
export const goodbuffer = createActor(canisterId);
